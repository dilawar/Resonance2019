...
\boxTexteven{Bistability in reaction network} {
    ...
    %        \includegraphics[width=7cm]{./strong_bis_naren_and_bhalla.pdf}
    ...
    \begin{tikzpicture}[scale=1 , every node/.style={} ]
        \node[] (img) {
                \includegraphics[width=8.7cm]{./strong_bis_naren_and_bhalla.pdf}
            };

        \node[right=-5mm of img, text width=4.8cm, align=justify] {
                A bistable chemical system adapted from \cite{ramakrishnan2008}.
                Species $b$ and $c$ catalyze their production (positive feedback) and
                inhibits production of $a$. On right, two trajectories are shown in
                different settings. (top) System is deterministic; (bottom) System is
                stochastic.
            };
    \end{tikzpicture}	
}
