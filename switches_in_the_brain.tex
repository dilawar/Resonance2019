...
\boxTexteven{Bistability in reaction network} {
    ...
    molecules. Bistable chemical reaction network is the commonest motif in
    ...
    point of view of experimentalist, if you obverse a bistable system for very
    ...
    Such stochastic bistable motif are commonplace in biology, especially found
    in situations where cell has to make a decision such as cell division where
    cell has to decide if to go to next state or not, and during cellular
    differentiation when cell has to decide among possible fates.
